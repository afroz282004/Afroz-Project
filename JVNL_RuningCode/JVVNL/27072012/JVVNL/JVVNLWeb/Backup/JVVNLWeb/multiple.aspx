...
jQuery(document).ready(function() {
	...
	DisableFields();
	document.getElementById("ctl00_contentplaceholder1_paymentdata").value="";
								...
								<div class="form_place"  id="form1">
									...
									<table class="fieldtable" >
									    ...
									    <tr>
									     ...
									     <td><label id="ramount" class="lblvalue">0</label><input type="hidden" name="paymentdata" id="paymentdata" runat="server" /> </td>
									...
									<fieldset>
									    ...
									    <%--******************  --%>
									      ...
									      <center>									        
									        <center><asp:Button CssClass="button green small" id="complete" runat="server" 
                                                    Text="Submit" onclick="complete_Click"   OnClientClick="javascript:return ValidateComplete();"  />
									        <%--<button type="button" class="button green small" id="complete">Complete</button>--%>
									        </center>
...
//					     }
					    ...
					    $("#save").click(function() {
					        ...
					        if (document.getElementById("ctl00_contentplaceholder1_paymentdata").value.indexOf(billid +"#")>=0)
					        {
					        ...
					        document.getElementById("ctl00_contentplaceholder1_paymentdata").value= document.getElementById ("ctl00_contentplaceholder1_paymentdata").value + paymentdata ;
					        ShowReceipt(data);
...
//					    }
					    ...
					    function DeleteRecord(id,amt)
					    {
					        if (confirm("Are you sure you want to delete " + id)) {
					            ...
					            var paymentdata= document.getElementById("ctl00_contentplaceholder1_paymentdata").value; 
					            ...
					            for ( i=0; i < datarow.length -1; i++)
					            {
					                ...
					                {
					                    document.getElementById("ctl00_contentplaceholder1_paymentdata").value=document.getElementById("ctl00_contentplaceholder1_paymentdata").value + paydata[i];
					                    var j=0;
					    ...
					    function PopulatePaymentSummary() {
					        var username = document.getElementById("username").value;
					    $.post("handler/payment.ashx?type=summary&username=" + username , $("#form").serialize(),ShowSummary);                        					    
					    }
                        ...
                        function GenerateReceipt(id) {
                            ...
                            alert("Printing Receipt: " + id + " Close window to print");
